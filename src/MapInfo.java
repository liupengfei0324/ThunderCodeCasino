public class MapInfo extends MapInfoBase {
	...
	public int getNextDirection() {
		...
		if (!isOutOfBounds(xOfLocation_x - 1, yOfLocation_y - 1) && isGhost(xOfLocation_x - 1, yOfLocation_y - 1)
				&& !isOutOfBounds(xOfLocation_x + 1, yOfLocation_y + 1) && isGhost(xOfLocation_x + 1, yOfLocation_y + 1)
				&& !ghostWillMove()) {
			return mCurrentDirection;
		}
		if (!isOutOfBounds(xOfLocation_x - 1, yOfLocation_y + 1) && isGhost(xOfLocation_x - 1, yOfLocation_y + 1)
		...
		if (!isOutOfBounds(xOfLocation_x - 1, yOfLocation_y - 1) && isGhost(xOfLocation_x - 1, yOfLocation_y - 1)) {
			if (((mCurrentDirection == 0 && !isGhost(xOfLocation_x - 1, yOfLocation_y))
					|| (mCurrentDirection == 2 && !isGhost(xOfLocation_x, yOfLocation_y - 1))) && !ghostWillMove()) {
				return mCurrentDirection;
			} else {
				valuesFlag[0] += -500;
				valuesFlag[2] += -500;
		...
		if (!isOutOfBounds(xOfLocation_x + 1, yOfLocation_y - 1) && isGhost(xOfLocation_x + 1, yOfLocation_y - 1)) {
			if (((mCurrentDirection == 1 && !isGhost(xOfLocation_x + 1, yOfLocation_y))
					|| (mCurrentDirection == 2 && !isGhost(xOfLocation_x, yOfLocation_y - 1))) && !ghostWillMove()) {
				return mCurrentDirection;
			} else {
				valuesFlag[1] += -500;
